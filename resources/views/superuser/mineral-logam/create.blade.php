<x-layouts.superuser title="Tambah Data Mineral Logam">
    <h1 class="text-xl font-bold mb-1">Tambah Data Mineral Logam</h1>
    ...
    <div class="max-w-2xl bg-white border rounded-xl p-6">
        ...
        <form method="POST" action="{{ route('superuser.mineral-logam.store') }}" class="space-y-4">
            @csrf
            ...
            <div class="grid grid-cols-2 gap-3">
                <div>
                    ...
                    <input type="number" name="idml" value="{{ old('idml') }}" class="w-full border-gray-300 rounded-md text-sm">
                </div>
                <div>
                ...
                <div>
                    ...
                    <select name="komoditas_logam_id" class="w-full border-gray-300 rounded-md text-sm">
                        ...
                        @foreach($komoditasLogams as $k)
                            <option value="{{ $k->id }}">{{ $k->nama_komoditas }} ({{ $k->kelompokKomoditasLogam->nama_kelompok }})</option>
                        @endforeach
                    </select>
                </div>
                <div>
            ...
            <div class="grid grid-cols-2 gap-3">
                <div>
                    ...
                    <input type="number" step="0.001" name="hipotetik_bijih" value="{{ old('hipotetik_bijih', 0) }}" class="w-full border-gray-300 rounded-md text-sm">
                </div>
                <div>
                    <label class="text-xs text-gray-500 block mb-1">Hipotetik (logam)</label>
                    <input type="number" step="0.001" name="hipotetik_logam" value="{{ old('hipotetik_logam', 0) }}" class="w-full border-gray-300 rounded-md text-sm">
                </div>
                <div>
                    <label class="text-xs text-gray-500 block mb-1">Tereka (bijih)</label>
                    <input type="number" step="0.001" name="tereka_bijih" value="{{ old('tereka_bijih', 0) }}" class="w-full border-gray-300 rounded-md text-sm">
                </div>
                <div>
                    <label class="text-xs text-gray-500 block mb-1">Tereka (logam)</label>
                    <input type="number" step="0.001" name="tereka_logam" value="{{ old('tereka_logam', 0) }}" class="w-full border-gray-300 rounded-md text-sm">
                </div>
                <div>
                    <label class="text-xs text-gray-500 block mb-1">Tertunjuk (bijih)</label>
                    <input type="number" step="0.001" name="tertunjuk_bijih" value="{{ old('tertunjuk_bijih', 0) }}" class="w-full border-gray-300 rounded-md text-sm">
                </div>
                <div>
                    <label class="text-xs text-gray-500 block mb-1">Tertunjuk (logam)</label>
                    <input type="number" step="0.001" name="tertunjuk_logam" value="{{ old('tertunjuk_logam', 0) }}" class="w-full border-gray-300 rounded-md text-sm">
                </div>
                <div>
                    <label class="text-xs text-gray-500 block mb-1">Terukur (bijih)</label>
                    <input type="number" step="0.001" name="terukur_bijih" value="{{ old('terukur_bijih', 0) }}" class="w-full border-gray-300 rounded-md text-sm">
                </div>
                <div>
                    <label class="text-xs text-gray-500 block mb-1">Terukur (logam)</label>
                    <input type="number" step="0.001" name="terukur_logam" value="{{ old('terukur_logam', 0) }}" class="w-full border-gray-300 rounded-md text-sm">
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-3">
                <div>
                    ...
                    <input type="number" step="0.001" name="terkira_bijih" value="{{ old('terkira_bijih', 0) }}" class="w-full border-gray-300 rounded-md text-sm">
                </div>
                <div>
                    <label class="text-xs text-gray-500 block mb-1">Terkira (logam)</label>
                    <input type="number" step="0.001" name="terkira_logam" value="{{ old('terkira_logam', 0) }}" class="w-full border-gray-300 rounded-md text-sm">
                </div>
                <div>
                    <label class="text-xs text-gray-500 block mb-1">Terbukti (bijih)</label>
                    <input type="number" step="0.001" name="terbukti_bijih" value="{{ old('terbukti_bijih', 0) }}" class="w-full border-gray-300 rounded-md text-sm">
                </div>
                <div>
                    <label class="text-xs text-gray-500 block mb-1">Terbukti (logam)</label>
                    <input type="number" step="0.001" name="terbukti_logam" value="{{ old('terbukti_logam', 0) }}" class="w-full border-gray-300 rounded-md text-sm">
                </div>
            </div>
