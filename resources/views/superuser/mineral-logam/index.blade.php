<x-layouts.superuser title="Data Mineral Logam">
    <div class="flex justify-between items-end mb-4">
        <div>
            <h1 class="text-xl font-bold">Data Mineral Logam</h1>
            <p class="text-xs text-gray-500">Kelola data neraca — Super User</p>
        </div>
        <div class="flex gap-2">
    <a href="{{ route('superuser.mineral-logam.import.form') }}" class="border border-gray-300 text-sm font-semibold px-4 py-2 rounded-md">
        Import Excel
    </a>
    <a href="{{ route('superuser.mineral-logam.create') }}" class="bg-[#F2C230] hover:bg-[#e0b526] text-black text-sm font-semibold px-4 py-2 rounded-md">
        + Tambah Data
    </a>
</div>
    </div>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-3 py-2 text-center">
                            <a href="{{ route('superuser.mineral-logam.edit', $row) }}" class="text-blue-600 hover:underline mr-3">Edit</a>
                            <form method="POST" action="{{ route('superuser.mineral-logam.destroy', $row) }}" class="inline"
